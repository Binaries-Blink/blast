...
pub fn readTypeExpr(alloc: std.mem.Allocator, node: AstNode.TypeExpr) Error!*Type {
    if (node.nullable) {
...
fn readConst(alloc: std.mem.Allocator, node: AstNode.ConstStmt) Error!*Type {
...
fn readFn(alloc: std.mem.Allocator, node: AstNode.FnStmt) Error!*Type {
